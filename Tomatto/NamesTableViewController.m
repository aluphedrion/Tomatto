...
{
    static NSString *CellIdentifier = @"IngredientName";
    IngredientNameCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    
    Ingredient *ingredient = [self.recipe.ingredients objectAtIndex:indexPath.row];
    cell.title.text = ingredient.name;
